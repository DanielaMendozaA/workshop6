...
const whileIdHabitaciones = function(rooms){
    ...
    while(habitacionesID.length === 0){
        idHabitaciones = Number(prompt("Ingrese un numero de id valido"))
        habitacionesID = rooms.filter(room => room.roomTypeId === idHabitaciones && room.availability == true)
    }
...
export const generarReserva = function(rooms, roomTypes){
    ...
    let resultado = whileIdHabitaciones(rooms)
